...
document.getElementById("start-btn").addEventListener("click", function() {
    ...
    document.getElementById("bfs-output").value = "";
...
document.getElementById("bfs-btn").addEventListener("click", function() {
    ...
    const traversalResult = bfs(startNode);
    document.getElementById("bfs-output").value = `BFS traversal starting from node ${startNode} is: ${traversalResult.join(' -> ')}`;
});
